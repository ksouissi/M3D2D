...
#ifdef NOW
void D2D3M(int L0, int U0, int L1, int U1, int L2, int U2, int L3, int U3, int L4, int U4, int L5, int U5, int L6, int U6, int L7, int U7, int z0, int z1, int t, int x0, int x1, int x2, int y0, int y1, int y2, int z, unsigned O[], int x, int y)
{
    int i, j, k, G[9][4];
    ...
    for (x = -(G[8][0] < x) & x | -(G[8][0] >= x) & G[8][0], y = -(G[8][1] < y) & y | -(G[8][1] >= y) & G[8][1]; y < G[8][3]; x = G[8][0], y++)
        for (; x < G[8][2]; x++)
            if (!p[(y << LOG_R) + x]) {
                if (G[8][2] - G[8][0] <= 2 || G[8][3] - G[8][1] <= 2 || !z) {
                    if (y2 >= 0)
                        for (; y < G[8][3]; x = G[8][0], y++)
                            for (; x < G[8][2]; x++)
                                if (!p[(y << LOG_R) + x])
                                    p[(y << LOG_R) + x] = O[8] << 8 & 0xff0000 | O[8] >> 8 & 0xff00 | O[8] & 0xff;
                    return;
                }
                for (;; L(0) += i << 31 >> 31 & V0(2) >> LOG_R - t, U(0) += i << 30 >> 31 & V0(2) >> LOG_R - t, L(1) += i << 31 >> 31 & V1(2) >> LOG_R - t, U(1) += i << 30 >> 31 & V1(2) >> LOG_R - t, L(2) += i << 31 >> 31 & V2(2) >> LOG_R - t, U(2) += i << 30 >> 31 & V2(2) >> LOG_R - t, L(3) += i << 31 >> 31 & V3(2) >> LOG_R - t, U(3) += i << 30 >> 31 & V3(2) >> LOG_R - t, L(4) += i << 31 >> 31 & V4(2) >> LOG_R - t, U(4) += i << 30 >> 31 & V4(2) >> LOG_R - t, L(5) += i << 31 >> 31 & V5(2) >> LOG_R - t, U(5) += i << 30 >> 31 & V5(2) >> LOG_R - t, L(6) += i << 31 >> 31 & V6(2) >> LOG_R - t, U(6) += i << 30 >> 31 & V6(2) >> LOG_R - t, L(7) += i << 31 >> 31 & V7(2) >> LOG_R - t, U(7) += i << 30 >> 31 & V7(2) >> LOG_R - t, /* L0 += i << 31 >> 31 & V0(2) >> LOG_R - t, U0 += i << 30 >> 31 & V0(2) >> LOG_R - t, L1 += i << 31 >> 31 & V1(2) >> LOG_R - t, U1 += i << 30 >> 31 & V1(2) >> LOG_R - t, L2 += i << 31 >> 31 & V2(2) >> LOG_R - t, U2 += i << 30 >> 31 & V2(2) >> LOG_R - t, L3 += i << 31 >> 31 & V3(2) >> LOG_R - t, U3 += i << 30 >> 31 & V3(2) >> LOG_R - t, L4 += i << 31 >> 31 & V4(2) >> LOG_R - t, U4 += i << 30 >> 31 & V4(2) >> LOG_R - t, L5 += i << 31 >> 31 & V5(2) >> LOG_R - t, U5 += i << 30 >> 31 & V5(2) >> LOG_R - t, L6 += i << 31 >> 31 & V6(2) >> LOG_R - t, U6 += i << 30 >> 31 & V6(2) >> LOG_R - t, L7 += i << 31 >> 31 & V7(2) >> LOG_R - t, U7 += i << 30 >> 31 & V7(2) >> LOG_R - t, */ --t, z0 += (i & 0x1) << t, z1 += i >> 1 << t)
                    if ((i = DIR0(t)) ^ DIR1(t) || i ^ DIR2(t) || i ^ DIR3(t)) {
                        for (i = 7, j = ((V[2] & (256 << OH) - 1) < x2 + (128 << z)) << 2 | ((V[1] & (256 << OH) - 1) < x1 + (128 << z)) << 1 | (V[0] & (256 << OH) - 1) < x0 + (128 << z), k = i ^ j; i >= 0; --i, k = i ^ j)
                            if (O[k]) {
                                D2D3M(L8(k, 0), U8(k, 0), L8(k, 1), U8(k, 1), L8(k, 2), U8(k, 2), L8(k, 3), U8(k, 3), L8(k, 4), U8(k, 4), L8(k, 5), U8(k, 5), L8(k, 6), U8(k, 6), L8(k, 7), U8(k, 7), z0, z1, t, x0 + ((k & 0x1) << 8 << z - 1), x1 + ((k >> 1 & 0x1) << 8 << z - 1), x2 + (k >> 2 << 8 << z - 1), y0 + ((k << 31 >> 31 & B[0][0]) + (k << 30 >> 31 & B[1][0]) + (k << 29 >> 31 & B[2][0]) << z - 1), y1 + ((k << 31 >> 31 & B[0][1]) + (k << 30 >> 31 & B[1][1]) + (k << 29 >> 31 & B[2][1]) << z - 1), y2 + ((k << 31 >> 31 & B[0][2]) + (k << 30 >> 31 & B[1][2]) + (k << 29 >> 31 & B[2][2]) << z - 1), z - 1, O[k], x, y);
                                for (; y < G[8][3]; x = G[8][0], y++)
                                    for (; x < G[8][2]; x++)
                                        if (!p[(y << LOG_R) + x])
                                            goto L0;
...
int NR(int L, int U, int R, int D, int z)
{
    int i;

    for (; U < D; U++)
        for (i = L; i < R; i++)
            if (zbuffer[(U << LOG_R) + i] > z)
                return 1;
    return 0;
}

void RC(int L, int U, int R, int D, int z, int c)
{
    int i;
...
#ifdef DIRECT
#define L8(i, j)    M(G[i][0][0], G[j][0][0])
#define U8(i, j)    M(G[i][1][0], G[j][1][0])
#define R8(i, j)    M(G[i][2][0], G[j][2][0])
#define D8(i, j)    M(G[i][3][0], G[j][3][0])

#define Z   16

#define O_  (256 << z) - 256 <= ABS(x0 - V[0]) >> LOG_R - 1 || (256 << z) - 256 <= ABS(x1 - V[1]) >> LOG_R - 1 || (256 << z) - 256 <= ABS(x2 - V[2]) >> LOG_R - 1   //(256 << z) - 256 <= ABS(x0 - V[0]) + ABS(x1 - V[1]) + ABS(x2 - V[2]) >> LOG_R - 1 //(256 << z) - 256 <= /* ABS(y0) + ABS(y1) + ABS(y2) */ y2 >> LOG_R - 1

void D2D3M(int L0, int U0, int R0, int D0, int L1, int U1, int R1, int D1, int L2, int U2, int R2, int D2, int L3, int U3, int R3, int D3, int L4, int U4, int R4, int D4, int L5, int U5, int R5, int D5, int L6, int U6, int R6, int D6, int L7, int U7, int R7, int D7, int L8, int U8, int R8, int D8, int x0, int x1, int x2, int y0, int y1, int y2, int z, unsigned O[])
{
    int i, j, k, G[9][4][2];

    for (i = 8; i >= 0; G[i][0][0] = L(i), G[i][1][0] = U(i), G[i][2][0] = R(i), G[i][3][0] = D(i), i--);
    for (j = 3; j >= 0; j--) {
        for (i = 8; i >= 0; G[i][j][1] = G[i][j + 2 & 0x3][0], i--);
        while (ABS(G[8][j][0] - G[8][j][1]) > 1 << Z)
    ...
    if (NR(G[8][0][0] >> Z, G[8][1][0] >> Z, G[8][2][0] >> Z, G[8][3][0] >> Z)) {
        if (G[8][2][0] - G[8][0][0] <= 2 << Z || G[8][3][0] - G[8][1][0] <= 2 << Z || !z    /* O_ */ /* (256 << z) - 256 <= ABS(y0) + ABS(y1) + ABS(y2) >> LOG_R - 1 */) {
            if (y2 >= 0)    /* use if no M3D2D stub */
                RC(G[8][0][0] >> Z, G[8][1][0] >> Z, G[8][2][0] >> Z, G[8][3][0] >> Z, O[8] << 8 & 0xff0000 | O[8] >> 8 & 0xff00 | O[8] & 0xff);
        } else
            for (i = 7, j = ((V[2] & (256 << OH) - 1) < x2 + (128 << z)) << 2 | ((V[1] & (256 << OH) - 1) < x1 + (128 << z)) << 1 | (V[0] & (256 << OH) - 1) < x0 + (128 << z), k = i ^ j; i >= 0; --i, k = i ^ j)
                if (O[k]) {
                    D2D3M(L8(k, 0), U8(k, 0), R8(k, 0), D8(k, 0), L8(k, 1), U8(k, 1), R8(k, 1), D8(k, 1), L8(k, 2), U8(k, 2), R8(k, 2), D8(k, 2), L8(k, 3), U8(k, 3), R8(k, 3), D8(k, 3), L8(k, 4), U8(k, 4), R8(k, 4), D8(k, 4), L8(k, 5), U8(k, 5), R8(k, 5), D8(k, 5), L8(k, 6), U8(k, 6), R8(k, 6), D8(k, 6), L8(k, 7), U8(k, 7), R8(k, 7), D8(k, 7), G[8][0][0], G[8][1][0], G[8][2][0], G[8][3][0], x0 + ((k & 0x1) << 8 << z - 1), x1 + ((k >> 1 & 0x1) << 8 << z - 1), x2 + (k >> 2 << 8 << z - 1), y0 + ((k << 31 >> 31 & B[0][0]) + (k << 30 >> 31 & B[1][0]) + (k << 29 >> 31 & B[2][0]) << z - 1), y1 + ((k << 31 >> 31 & B[0][1]) + (k << 30 >> 31 & B[1][1]) + (k << 29 >> 31 & B[2][1]) << z - 1), y2 + ((k << 31 >> 31 & B[0][2]) + (k << 30 >> 31 & B[1][2]) + (k << 29 >> 31 & B[2][2]) << z - 1), z - 1, O[k]);
                    if (!NR(G[8][0][0] >> Z, G[8][1][0] >> Z, G[8][2][0] >> Z, G[8][3][0] >> Z))
                        return;
                }
    }
...
#define DIR0(i) (G[8][1]J >> i - 1 << 1 & 0x2 | G[8][0]J >> i - 1 & 0x1)
#define DIR1(i) (G[8][1]J >> i - 1 << 1 & 0x2 | G[8][2]J - 1 >> i - 1 & 0x1)
#define DIR2(i) (G[8][3]J - 1 >> i - 1 << 1 & 0x2 | G[8][0]J >> i - 1 & 0x1)
#define DIR3(i) (G[8][3]J - 1 >> i - 1 << 1 & 0x2 | G[8][2]J - 1 >> i - 1 & 0x1)
...
void D2D3M(int L0, int U0, int R0, int D0, int L1, int U1, int R1, int D1, int L2, int U2, int R2, int D2, int L3, int U3, int R3, int D3, int L4, int U4, int R4, int D4, int L5, int U5, int R5, int D5, int L6, int U6, int R6, int D6, int L7, int U7, int R7, int D7, int z0, int z1, int t, int x0, int x1, int x2, int y0, int y1, int y2, int z, unsigned O[])
{
    int i, j, k, G[9][4][2];
    ...
    if (NR(G[8][0][0], G[8][1][0], G[8][2][0], G[8][3][0])) {
        if (G[8][2][0] - G[8][0][0] <= 2 || G[8][3][0] - G[8][1][0] <= 2 || !z /* (256 << z) - 256 <= ABS(y0) + ABS(y1) + ABS(y2) >> LOG_R - 1 */) {
            ...
            for (;; --t, z0 += (i & 0x1) << t, z1 += i >> 1 << t, L0 = L4(0, i), U0 = U4(0, i), R0 = R4(0, i), D0 = D4(0, i), L1 = L4(1, i), U1 = U4(1, i), R1 = R4(1, i), D1 = D4(1, i), L2 = L4(2, i), U2 = U4(2, i), R2 = R4(2, i), D2 = D4(2, i), L3 = L4(3, i), U3 = U4(3, i), R3 = R4(3, i), D3 = D4(3, i), L4 = L4(4, i), U4 = U4(4, i), R4 = R4(4, i), D4 = D4(4, i), L5 = L4(5, i), U5 = U4(5, i), R5 = R4(5, i), D5 = D4(5, i), L6 = L4(6, i), U6 = U4(6, i), R6 = R4(6, i), D6 = D4(6, i), L7 = L4(7, i), U7 = U4(7, i), R7 = R4(7, i), D7 = D4(7, i))
                if ((i = DIR0(t)) ^ DIR1(t) || i ^ DIR2(t) || i ^ DIR3(t)) {
                    for (i = 7, j = ((V[2] & (256 << OH) - 1) < x2 + (128 << z)) << 2 | ((V[1] & (256 << OH) - 1) < x1 + (128 << z)) << 1 | (V[0] & (256 << OH) - 1) < x0 + (128 << z), k = i ^ j; i >= 0; --i, k = i ^ j)
                        if (O[k]) {
                            D2D3M(L8(k, 0), U8(k, 0), R8(k, 0), D8(k, 0), L8(k, 1), U8(k, 1), R8(k, 1), D8(k, 1), L8(k, 2), U8(k, 2), R8(k, 2), D8(k, 2), L8(k, 3), U8(k, 3), R8(k, 3), D8(k, 3), L8(k, 4), U8(k, 4), R8(k, 4), D8(k, 4), L8(k, 5), U8(k, 5), R8(k, 5), D8(k, 5), L8(k, 6), U8(k, 6), R8(k, 6), D8(k, 6), L8(k, 7), U8(k, 7), R8(k, 7), D8(k, 7), z0, z1, t, x0 + ((k & 0x1) << 8 << z - 1), x1 + ((k >> 1 & 0x1) << 8 << z - 1), x2 + (k >> 2 << 8 << z - 1), y0 + ((k << 31 >> 31 & B[0][0]) + (k << 30 >> 31 & B[1][0]) + (k << 29 >> 31 & B[2][0]) << z - 1), y1 + ((k << 31 >> 31 & B[0][1]) + (k << 30 >> 31 & B[1][1]) + (k << 29 >> 31 & B[2][1]) << z - 1), y2 + ((k << 31 >> 31 & B[0][2]) + (k << 30 >> 31 & B[1][2]) + (k << 29 >> 31 & B[2][2]) << z - 1), z - 1, O[k]);
                            if (!NR(G[8][0][0], G[8][1][0], G[8][2][0], G[8][3][0]))
                                return;
                        }
                    return;
...
#ifndef N
void D2D3M(int L0, int U0, int L1, int U1, int L2, int U2, int L3, int U3, int L4, int U4, int L5, int U5, int L6, int U6, int L7, int U7, int z0, int z1, int t, int x0, int x1, int x2, int y0, int y1, int y2, int z, unsigned O[])
{
    int i, j, k, G[9][4][2];
        ...
        if (G[8][2][0] - G[8][0][0] <= 2 || G[8][3][0] - G[8][1][0] <= 2 || !z /* (256 << z) - 256 <= ABS(y0) + ABS(y1) + ABS(y2) >> LOG_R - 1 */) {
            ...
            for (;; L(0) += i << 31 >> 31 & V0(2) >> LOG_R - t, U(0) += i << 30 >> 31 & V0(2) >> LOG_R - t, L(1) += i << 31 >> 31 & V1(2) >> LOG_R - t, U(1) += i << 30 >> 31 & V1(2) >> LOG_R - t, L(2) += i << 31 >> 31 & V2(2) >> LOG_R - t, U(2) += i << 30 >> 31 & V2(2) >> LOG_R - t, L(3) += i << 31 >> 31 & V3(2) >> LOG_R - t, U(3) += i << 30 >> 31 & V3(2) >> LOG_R - t, L(4) += i << 31 >> 31 & V4(2) >> LOG_R - t, U(4) += i << 30 >> 31 & V4(2) >> LOG_R - t, L(5) += i << 31 >> 31 & V5(2) >> LOG_R - t, U(5) += i << 30 >> 31 & V5(2) >> LOG_R - t, L(6) += i << 31 >> 31 & V6(2) >> LOG_R - t, U(6) += i << 30 >> 31 & V6(2) >> LOG_R - t, L(7) += i << 31 >> 31 & V7(2) >> LOG_R - t, U(7) += i << 30 >> 31 & V7(2) >> LOG_R - t, /* L0 += i << 31 >> 31 & V0(2) >> LOG_R - t, U0 += i << 30 >> 31 & V0(2) >> LOG_R - t, L1 += i << 31 >> 31 & V1(2) >> LOG_R - t, U1 += i << 30 >> 31 & V1(2) >> LOG_R - t, L2 += i << 31 >> 31 & V2(2) >> LOG_R - t, U2 += i << 30 >> 31 & V2(2) >> LOG_R - t, L3 += i << 31 >> 31 & V3(2) >> LOG_R - t, U3 += i << 30 >> 31 & V3(2) >> LOG_R - t, L4 += i << 31 >> 31 & V4(2) >> LOG_R - t, U4 += i << 30 >> 31 & V4(2) >> LOG_R - t, L5 += i << 31 >> 31 & V5(2) >> LOG_R - t, U5 += i << 30 >> 31 & V5(2) >> LOG_R - t, L6 += i << 31 >> 31 & V6(2) >> LOG_R - t, U6 += i << 30 >> 31 & V6(2) >> LOG_R - t, L7 += i << 31 >> 31 & V7(2) >> LOG_R - t, U7 += i << 30 >> 31 & V7(2) >> LOG_R - t, */ --t, z0 += (i & 0x1) << t, z1 += i >> 1 << t)
                if ((i = DIR0(t)) ^ DIR1(t) || i ^ DIR2(t) || i ^ DIR3(t)) {
                    for (i = 7, j = ((V[2] & (256 << OH) - 1) < x2 + (128 << z)) << 2 | ((V[1] & (256 << OH) - 1) < x1 + (128 << z)) << 1 | (V[0] & (256 << OH) - 1) < x0 + (128 << z), k = i ^ j; i >= 0; --i, k = i ^ j)
                        if (O[k]) {
                            D2D3M(L8(k, 0), U8(k, 0), L8(k, 1), U8(k, 1), L8(k, 2), U8(k, 2), L8(k, 3), U8(k, 3), L8(k, 4), U8(k, 4), L8(k, 5), U8(k, 5), L8(k, 6), U8(k, 6), L8(k, 7), U8(k, 7), z0, z1, t, x0 + ((k & 0x1) << 8 << z - 1), x1 + ((k >> 1 & 0x1) << 8 << z - 1), x2 + (k >> 2 << 8 << z - 1), y0 + ((k << 31 >> 31 & B[0][0]) + (k << 30 >> 31 & B[1][0]) + (k << 29 >> 31 & B[2][0]) << z - 1), y1 + ((k << 31 >> 31 & B[0][1]) + (k << 30 >> 31 & B[1][1]) + (k << 29 >> 31 & B[2][1]) << z - 1), y2 + ((k << 31 >> 31 & B[0][2]) + (k << 30 >> 31 & B[1][2]) + (k << 29 >> 31 & B[2][2]) << z - 1), z - 1, O[k]);
                            if (!NR(G[8][0][0], G[8][1][0], G[8][2][0], G[8][3][0]))
                                return;
                        }
                    return;
...
void D2D3M(int L0, int U0, int L1, int U1, int L2, int U2, int L3, int U3, int L4, int U4, int L5, int U5, int L6, int U6, int L7, int U7, int z0, int z1, int t, int x0, int x1, int x2, int y0, int y1, int y2, int z, unsigned O[])
{
    ...
    for (i = t; i; i--)
        for (j = 3; j >= 0; j--)
            if (!N(j))
                for (G[8][j] += (j << 30 >> 31 ^ 1 << i - 1) + (j >> 1), k = 7; k >= 0; G[k][j] += (j << 30 >> 31 ^ V(k, 2) >> LOG_R - i) + (j >> 1), k--);
    if (NR(G[8][0], G[8][1], G[8][2], G[8][3])) {
        if (G[8][2] - G[8][0] <= 2 || G[8][3] - G[8][1] <= 2 || !z) {
            if (y2 >= 0)    /* use if no M3D2D stub */
                RC(G[8][0], G[8][1], G[8][2], G[8][3], O[8] << 8 & 0xff0000 | O[8] >> 8 & 0xff00 | O[8] & 0xff /* O[8] */);
        } else 
            for (;; L(0) += i << 31 >> 31 & V0(2) >> LOG_R - t, U(0) += i << 30 >> 31 & V0(2) >> LOG_R - t, L(1) += i << 31 >> 31 & V1(2) >> LOG_R - t, U(1) += i << 30 >> 31 & V1(2) >> LOG_R - t, L(2) += i << 31 >> 31 & V2(2) >> LOG_R - t, U(2) += i << 30 >> 31 & V2(2) >> LOG_R - t, L(3) += i << 31 >> 31 & V3(2) >> LOG_R - t, U(3) += i << 30 >> 31 & V3(2) >> LOG_R - t, L(4) += i << 31 >> 31 & V4(2) >> LOG_R - t, U(4) += i << 30 >> 31 & V4(2) >> LOG_R - t, L(5) += i << 31 >> 31 & V5(2) >> LOG_R - t, U(5) += i << 30 >> 31 & V5(2) >> LOG_R - t, L(6) += i << 31 >> 31 & V6(2) >> LOG_R - t, U(6) += i << 30 >> 31 & V6(2) >> LOG_R - t, L(7) += i << 31 >> 31 & V7(2) >> LOG_R - t, U(7) += i << 30 >> 31 & V7(2) >> LOG_R - t, /* L0 += i << 31 >> 31 & V0(2) >> LOG_R - t, U0 += i << 30 >> 31 & V0(2) >> LOG_R - t, L1 += i << 31 >> 31 & V1(2) >> LOG_R - t, U1 += i << 30 >> 31 & V1(2) >> LOG_R - t, L2 += i << 31 >> 31 & V2(2) >> LOG_R - t, U2 += i << 30 >> 31 & V2(2) >> LOG_R - t, L3 += i << 31 >> 31 & V3(2) >> LOG_R - t, U3 += i << 30 >> 31 & V3(2) >> LOG_R - t, L4 += i << 31 >> 31 & V4(2) >> LOG_R - t, U4 += i << 30 >> 31 & V4(2) >> LOG_R - t, L5 += i << 31 >> 31 & V5(2) >> LOG_R - t, U5 += i << 30 >> 31 & V5(2) >> LOG_R - t, L6 += i << 31 >> 31 & V6(2) >> LOG_R - t, U6 += i << 30 >> 31 & V6(2) >> LOG_R - t, L7 += i << 31 >> 31 & V7(2) >> LOG_R - t, U7 += i << 30 >> 31 & V7(2) >> LOG_R - t, */ --t, z0 += (i & 0x1) << t, z1 += i >> 1 << t)
                if ((i = DIR0(t)) ^ DIR1(t) || i ^ DIR2(t) || i ^ DIR3(t)) {
                    for (i = 7, j = ((V[2] & (256 << OH) - 1) < x2 + (128 << z)) << 2 | ((V[1] & (256 << OH) - 1) < x1 + (128 << z)) << 1 | (V[0] & (256 << OH) - 1) < x0 + (128 << z), k = i ^ j; i >= 0; --i, k = i ^ j)
...
void D2D3M(int L0, int U0, int L1, int U1, int L2, int U2, int L3, int U3, int L4, int U4, int L5, int U5, int L6, int U6, int L7, int U7, int z0, int z1, int t, int y0, int y1, int y2, int z, unsigned O[])
{
    int i, j, k, G[9][4];
    ...
    for (i = t; i; i--)
        for (j = 3; j >= 0; j--)
            if (!N(j))
                for (G[8][j] += (j << 30 >> 31 ^ 1 << i - 1) + (j >> 1), k = 7; k >= 0; G[k][j] += (j << 30 >> 31 ^ V(k, 2) >> LOG_R - i) + (j >> 1), k--);
    if (NR(G[8][0], G[8][1], G[8][2], G[8][3], M(V0(2), V7(2)) /* V(i, 2) */)) {
        if (G[8][2] - G[8][0] <= 2 || G[8][3] - G[8][1] <= 2 || !z) {
            if (y2 >= 0)    /* use if no M3D2D stub */
                RC(G[8][0], G[8][1], G[8][2], G[8][3], M(V0(2), V7(2)) /* V(i, 2) */, O[8] << 8 & 0xff0000 | O[8] >> 8 & 0xff00 | O[8] & 0xff /* O[8] */);
        } else 
            for (;; L(0) += j << 31 >> 31 & V0(2) >> LOG_R - t, U(0) += j << 30 >> 31 & V0(2) >> LOG_R - t, L(1) += j << 31 >> 31 & V1(2) >> LOG_R - t, U(1) += j << 30 >> 31 & V1(2) >> LOG_R - t, L(2) += j << 31 >> 31 & V2(2) >> LOG_R - t, U(2) += j << 30 >> 31 & V2(2) >> LOG_R - t, L(3) += j << 31 >> 31 & V3(2) >> LOG_R - t, U(3) += j << 30 >> 31 & V3(2) >> LOG_R - t, L(4) += j << 31 >> 31 & V4(2) >> LOG_R - t, U(4) += j << 30 >> 31 & V4(2) >> LOG_R - t, L(5) += j << 31 >> 31 & V5(2) >> LOG_R - t, U(5) += j << 30 >> 31 & V5(2) >> LOG_R - t, L(6) += j << 31 >> 31 & V6(2) >> LOG_R - t, U(6) += j << 30 >> 31 & V6(2) >> LOG_R - t, L(7) += j << 31 >> 31 & V7(2) >> LOG_R - t, U(7) += j << 30 >> 31 & V7(2) >> LOG_R - t, /* L0 += j << 31 >> 31 & V0(2) >> LOG_R - t, U0 += j << 30 >> 31 & V0(2) >> LOG_R - t, L1 += j << 31 >> 31 & V1(2) >> LOG_R - t, U1 += j << 30 >> 31 & V1(2) >> LOG_R - t, L2 += j << 31 >> 31 & V2(2) >> LOG_R - t, U2 += j << 30 >> 31 & V2(2) >> LOG_R - t, L3 += j << 31 >> 31 & V3(2) >> LOG_R - t, U3 += j << 30 >> 31 & V3(2) >> LOG_R - t, L4 += j << 31 >> 31 & V4(2) >> LOG_R - t, U4 += j << 30 >> 31 & V4(2) >> LOG_R - t, L5 += j << 31 >> 31 & V5(2) >> LOG_R - t, U5 += j << 30 >> 31 & V5(2) >> LOG_R - t, L6 += j << 31 >> 31 & V6(2) >> LOG_R - t, U6 += j << 30 >> 31 & V6(2) >> LOG_R - t, L7 += j << 31 >> 31 & V7(2) >> LOG_R - t, U7 += j << 30 >> 31 & V7(2) >> LOG_R - t, */ --t, z0 += (j & 0x1) << t, z1 += j >> 1 << t)
                if ((j = DIR0(t)) ^ DIR1(t) || i ^ DIR2(t) || i ^ DIR3(t)) {
                    for (k = 7; k >= 0; k--)
                        if (O[k]) {
                            D2D3M(L8(k, 0), U8(k, 0), L8(k, 1), U8(k, 1), L8(k, 2), U8(k, 2), L8(k, 3), U8(k, 3), L8(k, 4), U8(k, 4), L8(k, 5), U8(k, 5), L8(k, 6), U8(k, 6), L8(k, 7), U8(k, 7), z0, z1, t, y0 + ((k << 31 >> 31 & B[0][0]) + (k << 30 >> 31 & B[1][0]) + (k << 29 >> 31 & B[2][0]) << z - 1), y1 + ((k << 31 >> 31 & B[0][1]) + (k << 30 >> 31 & B[1][1]) + (k << 29 >> 31 & B[2][1]) << z - 1), y2 + ((k << 31 >> 31 & B[0][2]) + (k << 30 >> 31 & B[1][2]) + (k << 29 >> 31 & B[2][2]) << z - 1), z - 1, O[k]);
                            if (!NR(G[8][0], G[8][1], G[8][2], G[8][3], M(V0(2), V7(2)) /* V(i, 2) */))
                                return;
                        }
                    return;
...
void M3D2D(int x, int y, int t, int y0, int y1, int y2, int z, int O[])
{
    ...
    if (i = CODE()) {
...
#ifndef LURD
        D2D3M(-V0(2), -V0(2), -V1(2), -V1(2), -V2(2), -V2(2), -V3(2), -V3(2), -V4(2), -V4(2), -V5(2), -V5(2), -V6(2), -V6(2), -V7(2), -V7(2), 0, 0, LOG_R, 
#ifndef ZBUFFER
                                                                                                                                                            x, y, t, 
#endif
                                                                                                                                                            y0, y1, y2, z, O);
        ...
        D2D3M(-V0(2), -V0(2), V0(2), V0(2), -V1(2), -V1(2), V1(2), V1(2), -V2(2), -V2(2), V2(2), V2(2), -V3(2), -V3(2), V3(2), V3(2), -V4(2), -V4(2), V4(2), V4(2), -V5(2), -V5(2), V5(2), V5(2), -V6(2), -V6(2), V6(2), V6(2), -V7(2), -V7(2), V7(2), V7(2), 0, 0,
#ifdef DIRECT
                                                                                                                                                                                                                                                                    1 << LOG_R << Z, 1 << LOG_R << Z, 
#else
                                                                                                                                                                                                                                                                    LOG_R, 
...
//            D2D3M(-V(0, 2), -V(0, 2), -V(1, 2), -V(1, 2), -V(2, 2), -V(2, 2), -V(3, 2), -V(3, 2), -V(4, 2), -V(4, 2), -V(5, 2), -V(5, 2), -V(6, 2), -V(6, 2), -V(7, 2), -V(7, 2), 0, 0, LOG_R, V(0, 0), V(0, 1), V(0, 2), OH, octrees);
//            M3D2D(0, 0, 0, V(0, 0), V(0, 1), V(0, 2), OH, octrees);
//            D2D3M(-V(0, 2), -V(0, 2), -V(1, 2), -V(1, 2), -V(2, 2), -V(2, 2), -V(3, 2), -V(3, 2), -V(4, 2), -V(4, 2), -V(5, 2), -V(5, 2), -V(6, 2), -V(6, 2), -V(7, 2), -V(7, 2), 0, 0, LOG_R, 0, 0, 0, V(0, 0), V(0, 1), V(0, 2), OH, octrees /*, 0, 0*/);
            D2D3M(-V(0, 2), -V(0, 2), V(0, 2), V(0, 2), -V(1, 2), -V(1, 2), V(1, 2), V(1, 2), -V(2, 2), -V(2, 2), V(2, 2), V(2, 2), -V(3, 2), -V(3, 2), V(3, 2), V(3, 2), -V(4, 2), -V(4, 2), V(4, 2), V(4, 2), -V(5, 2), -V(5, 2), V(5, 2), V(5, 2), -V(6, 2), -V(6, 2), V(6, 2), V(6, 2), -V(7, 2), -V(7, 2), V(7, 2), V(7, 2), 0, 0, 1 << LOG_R << Z, 1 << LOG_R << Z, 0, 0, 0, V(0, 0), V(0, 1), V(0, 2), OH, octrees);
//            D2D3M(-V(0, 2), -V(0, 2), V(0, 2), V(0, 2), -V(1, 2), -V(1, 2), V(1, 2), V(1, 2), -V(2, 2), -V(2, 2), V(2, 2), V(2, 2), -V(3, 2), -V(3, 2), V(3, 2), V(3, 2), -V(4, 2), -V(4, 2), V(4, 2), V(4, 2), -V(5, 2), -V(5, 2), V(5, 2), V(5, 2), -V(6, 2), -V(6, 2), V(6, 2), V(6, 2), -V(7, 2), -V(7, 2), V(7, 2), V(7, 2), 0, 0, 1 << LOG_R << Z, 1 << LOG_R << Z, V(0, 0), V(0, 1), V(0, 2), OH, octrees);
            BitBlt(hdc, 0, 0, 1 << LOG_R, 1 << LOG_R /* 768 */, hdcm, 0, 0, SRCCOPY);
