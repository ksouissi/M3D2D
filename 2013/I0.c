        ...
        if (O_)
            for (;;)
                if (Q1) {
                    ...
                    p[(E[Z] - (1 << LOG_R + 1 + 16) >> 16 << LOG_R) + (E[Z] - (1 << LOG_R + 1) & (1 << LOG_R) - 1)] = ((int *)E[O])[8];
                    do {
                        B(E[Q]);
                        E[Q] = QF(E[Q]);
                    } while (ACB(E[Q]));
...
L0:
            if (O_) {
                if (V_(0, 0) < F_(0, 0) || V_(0, 1) < F_(0, 1) || V_(0, 0) >= F_(0, 2) || V_(0, 1) >= F_(0, 3))
                    continue;
                QL_1();
                goto L2;
            }
...
L2:
            for (;;)
                if (Q1) {
                    ...
                    p[(E[Z] >> 16 << LOG_R) + (E[Z] & (1 << LOG_R) - 1)] = ((int *)E[O])[8] << 8 & 0xff0000 | ((int *)E[O])[8] >> 8 & 0xff00 | ((int *)E[O])[8] & 0xff;
                    do {
                        B(E[Q]);
                        E[Q] = QF(E[Q]);
                    } while (ACB(E[Q]));
