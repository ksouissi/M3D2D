...
int NR(int L, int U, int R, int D, int x, int y, int z, unsigned Q)
{
    ...
    if (!NB(Q) || x >= R || y >= D || x + (1 << z) <= L || y + (1 << z) <= U)
        return 0;
    if (!NW(Q))
        return 1;
            ...
            if (NR(G[8][0][0], G[8][1][0], G[8][2][0], G[8][3][0], z0, z1, t, Q)) {
                if (O_)
                    for (RC(G[8][0][0], G[8][1][0], G[8][2][0], G[8][3][0], z0, z1, t, Q, O[8] << 8 & 0xff0000 | O[8] >> 8 & 0xff00 | O[8] & 0xff);;) {
                        Q = QF(Q);
                        if (CNB(Q)) { while (!NW(Q)) { BW(Q); Q = QF(Q); } return; }
                        B(Q);
                    }
...
/*        for (j = 0; j < 8; j++)
    ...
    for (;;) {
        if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE)) {
            ...
            QR();
			M3D2D(-(V(0, 2) << 2) - V(0, 2), -(V(0, 2) << 2) - V(0, 2), (V(0, 2) << 1) + V(0, 2), (V(0, 2) << 1) + V(0, 2), -(V(1, 2) << 2) - V(1, 2), -(V(1, 2) << 2) - V(1, 2), (V(1, 2) << 1) + V(1, 2), (V(1, 2) << 1) + V(1, 2), -(V(2, 2) << 2) - V(2, 2), -(V(2, 2) << 2) - V(2, 2), (V(2, 2) << 1) + V(2, 2), (V(2, 2) << 1) + V(2, 2), -(V(3, 2) << 2) - V(3, 2), -(V(3, 2) << 2) - V(3, 2), (V(3, 2) << 1) + V(3, 2), (V(3, 2) << 1) + V(3, 2), -(V(4, 2) << 2) - V(4, 2), -(V(4, 2) << 2) - V(4, 2), (V(4, 2) << 1) + V(4, 2), (V(4, 2) << 1) + V(4, 2), -(V(5, 2) << 2) - V(5, 2), -(V(5, 2) << 2) - V(5, 2), (V(5, 2) << 1) + V(5, 2), (V(5, 2) << 1) + V(5, 2), -(V(6, 2) << 2) - V(6, 2), -(V(6, 2) << 2) - V(6, 2), (V(6, 2) << 1) + V(6, 2), (V(6, 2) << 1) + V(6, 2), -(V(7, 2) << 2) - V(7, 2), -(V(7, 2) << 2) - V(7, 2), (V(7, 2) << 1) + V(7, 2), (V(7, 2) << 1) + V(7, 2), 0, 0, 0, V(0, 0), V(0, 1), V(0, 2), OH, 0, 0, LOG_R + 2, octrees, 6);
            BitBlt(hdc, 0, 0, 1 << LOG_R, 1 << LOG_R /* 768 */, hdcm, 0, 0, SRCCOPY);
